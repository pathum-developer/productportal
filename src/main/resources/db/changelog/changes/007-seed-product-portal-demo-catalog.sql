...
--changeset elvencode:007-seed-product-portal-demo-catalog context:demo

-- Demo-only catalog data used by local development and integration tests.
...
WHERE pp_m_product.organization_id IS DISTINCT FROM EXCLUDED.organization_id
   OR pp_m_product.owner_user_id IS DISTINCT FROM EXCLUDED.owner_user_id
